...
Config.ClothingRooms = {
    [1] = {requiredJob = "police", coords = vector3(461.18, -996.58, 30.69), cameraLocation = vector4(461.18, -996.58, 30.69, 100.0)},
    [2] = {requiredJob = "ambulance", coords = vector3(298.99, -598.63, 43.28), cameraLocation = vector4(298.99, -598.63, 43.28, 250.0)},
    [3] = {requiredJob = "burgershot", coords = vector3(-1185.19, -900.46, 13.98), cameraLocation = vector4(-1185.19, -900.46, 13.98, 250.0)},
...
Config.Outfits = {
    ["police"] = {
        ["male"] = {
            [1] = {
                outfitLabel = "BCSO Patrol",
                outfitData = {
                    ["pants"]       = { item = 10, texture = 0},  -- PANTS
                    ["arms"]        = { item = 11, texture = 0},  -- ArmS
                    ["t-shirt"]     = { item = 205, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 72, texture = 0},  -- VEST
                    ["torso2"]      = { item = 400, texture = 0},  -- JACKET
                    ["shoes"]       = { item = 25, texture = 0},  -- SHOES
                    ["decals"]      = { item = 126, texture = 0},  -- Decals
                    ["accessory"]   = { item = 168, texture = 0},  -- Neck
            ...
            --      ["ear"]         = { item = 0, texture = 0},  -- EAR accessoires
                ...
                [2] = {
                    outfitLabel = "LSPD Patrol",
                    outfitData = {
                        ["pants"]       = { item = 10, texture = 0},  -- PANTS
                        ["arms"]        = { item = 11, texture = 0},  -- ArmS
                        ["t-shirt"]     = { item = 205, texture = 0},  -- T Shirt
                        ["vest"]        = { item = 72, texture = 0},  -- VEST
                        ["torso2"]      = { item = 400, texture = 3},  -- JACKET
                        ["shoes"]       = { item = 25, texture = 0},  -- SHOES
                        ["decals"]      = { item = 125, texture = 0},  -- Decals
                        ["accessory"]   = { item = 168, texture = 0},  -- Neck
                        ["bag"]         = { item = 0, texture = 0},  -- BAG
                        ["hat"]         = { item = -1, texture = -1},  -- HAT
                        ["glass"]       = { item = 0, texture = 0},  -- GLASSES
                --      ["ear"]         = { item = 0, texture = 0},  -- EAR accessoires
                    ...
                    [3] = {
                        outfitLabel = "SASP Patrol",
                        outfitData = {
                            ["pants"]       = { item = 10, texture = 0},  -- PANTS
                            ["arms"]        = { item = 11, texture = 0},  -- ArmS
                            ["t-shirt"]     = { item = 205, texture = 0},  -- T Shirt
                            ["vest"]        = { item = 72, texture = 0},  -- VEST
                            ["torso2"]      = { item = 400, texture = 6},  -- JACKET
                            ["shoes"]       = { item = 25, texture = 0},  -- SHOES
                            ["decals"]      = { item = 126, texture = 3},  -- Decals
                            ["accessory"]   = { item = 168, texture = 0},  -- Neck
                            ["bag"]         = { item = 0, texture = 0},  -- BAG
                            ["hat"]         = { item = -1, texture = -1},  -- HAT
                            ["glass"]       = { item = 0, texture = 0},  -- GLASSES
    ...
    ["burgershot"] = {
        ["male"] = {
            [1] = {
                outfitLabel = "Uniform",
                outfitData = {
                    ["pants"]       = { item = 27,texture = 4},  -- Broek
                    ["arms"]        = { item = 0, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = -1, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 382, texture = 7},  -- Jas / Vesten
                    ["shoes"]       = { item = 57, texture = 3},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 0, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 0, texture = 0},  -- Tas
                    ["hat"]         = { item = -1, texture = -1},  -- Pet

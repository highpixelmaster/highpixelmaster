...
Config.numbertogive = 2 -- Number of items to give
...
Config.locations = {
    ["positions"] = { -- DON'T CHANGE
        [1] = vector3(2215.98, 5579.53, 53.94), -- Position 1
        [2] = vector3(2223.74, 5574.89, 53.74), -- Position 2
        [3] = vector3(2234.99, 5576.21, 54.03)  -- Position 3
    }
}

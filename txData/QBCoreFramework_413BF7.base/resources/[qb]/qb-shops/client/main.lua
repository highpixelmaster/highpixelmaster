...
RegisterNetEvent("qb-shops:client:UseVending")
AddEventHandler("qb-shops:client:UseVending", function()
        local ShopItems = {}
...
AddEventHandler("qb-shops:client:UseVending2", function()
        local ShopItems = {}
        ShopItems.label = "Vending Machine"
        ShopItems.items = Config.VendingItem2
        ShopItems.slots = #Config.VendingItem2
        TriggerServerEvent("inventory:server:OpenInventory", "shop", "Vendingshop_"..math.random(1, 99), ShopItems)
end)

RegisterNetEvent("qb-shops:client:useCoffee")
AddEventHandler("qb-shops:client:useCoffee", function()
        local ShopItems = {}
        ShopItems.label = "Vending Machine"
...
Citizen.CreateThread(function()
	...
	if Config.Locations[store]["showblip"] then
        ...
        elseif Config.Locations[store]["products"] == Config.Products["digitalden"] then
	        SetBlipSprite(StoreBlip, 355)
	        SetBlipScale(StoreBlip, 0.55)
            SetBlipColour(StoreBlip, 50)

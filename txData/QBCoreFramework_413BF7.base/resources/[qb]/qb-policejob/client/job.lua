...
AddEventHandler('Toggle:Duty', function(playerId)
    onDuty = not onDuty
...
exports['qb-target']:AddBoxZone("onDuty", vector3(442.0, -982.05, 30.69), 1, 1, {
	name="onDuty",
	heading=5.0,
	debugPoly=false,
    minZ=30.79,
...
RegisterNetEvent('Fingerprints:Grab')
AddEventHandler('Fingerprints:Grab', function(playerId)
    local player, distance = GetClosestPlayer()
...
exports['qb-target']:AddBoxZone("fingerprints", vector3(483.61, -988.7, 30.69), 1, 1, {
	name="onDuty",
	heading=0.0,
	debugPoly=false,
    minZ=30.79,
    maxZ=30.99
		...
		options = {
			{
            	type = "client",
            	event = "Fingerprints:Grab",
				icon = "fas fa-fingerprint",
				label = "Grab Fingerprints",
				job = "police",
			},
		},
		distance = 3.5
...
exports['qb-target']:AddBoxZone("evidence1", vector3(474.91, -993.68, 26.27), 2, 2, {
	name="onDuty",
	heading=0.0,
	debugPoly=false,
    minZ=25.27,
    maxZ=29.27
		...
		options = {
			{
            	type = "client",
            	event = "evidence:view1",
				icon = "fas fa-boxes",
				label = "Place Evidence (Use Report Number as Stash Number)",
				job = "police",
			},
		},
		distance = 3.5
...
RegisterNetEvent('armory:view')
AddEventHandler('armory:view', function(playerId)
    local authorizedItems = {
        label = "Police Armory",
        slots = 30,
        items = {}
...
exports['qb-target']:AddBoxZone("armory", vector3(479.87, -996.72, 30.69), 1, 1, {
	name="onDuty",
	heading=0.0,
	debugPoly=false,
    minZ=28.49,

...
RegisterNetEvent("qb-fishing:sellallfish")
AddEventHandler("qb-fishing:sellallfish", function()
	SellFish() 
end)
...
exports['qb-target']:AddBoxZone("sellallfish", vector3(-1037.8, -1397.05, 5.55), 5.0, 1.0, {
	name="sellfish",
	heading=345,
	debugPoly=false,
	}, {
		options = {
			{
            	type = "client",
            	event = "qb-fishing:sellallfish",
				icon = "fas fa-fish",
				label = "Sell Fish",
			},
			{
            	type = "client",
            	event = "qb-shops:client:BuyFishStuff",
				icon = "fas fa-fish",
				label = "Buy Items",
			},
		},

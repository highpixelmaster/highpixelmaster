QBCore.Commands.Add("rolldice", "Roll a number of dice :)", {{name="amount", help="Amount of dices"}, {name="sides", help="Amount of sides of the dice"}}, true, function(source, args)

...
-- MENU
local menu = MenuV:CreateMenu(false, 'Boss Menu', 'topright', 35, 173, 119, 'size-125', 'none', 'menuv', 'main')
local menu2 = MenuV:CreateMenu(false, 'Society money', 'topright', 35, 173, 119, 'size-125', 'none', 'menuv', 'society')
local menu3 = MenuV:CreateMenu(false, 'Employee Management', 'topright', 35, 173, 119, 'size-125', 'none', 'menuv', 'employees')
local menu4 = MenuV:CreateMenu(false, 'Recruit Menu', 'topright', 35, 173, 119, 'size-125', 'none', 'menuv', 'recruit')
...
function ManageEmployees(employee)
    local manageroptions = MenuV:CreateMenu(false, employee.name .. ' Options', 'topright', 35, 173, 119, 'size-125', 'none', 'menuv')

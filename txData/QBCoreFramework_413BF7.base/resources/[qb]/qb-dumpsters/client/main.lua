...
CreateThread(function()
	while true do
        ...
        if not (NearbyDumpster2 or NearbyDumpster3 or NearbyDumpster4 or NearbyDumpster5 or NearbyDumpster6) then 
            ...
            Dumpster1 = GetClosestObjectOfType(PlayerCoords, 3.0, 218085040, false, false, false)
            if Dumpster1 ~= 0 then
...
CreateThread(function()
	while true do
        ...
        if not (NearbyDumpster1 or NearbyDumpster3 or NearbyDumpster4 or NearbyDumpster5 or NearbyDumpster6) then 
            WaitTime = 500
            local PlayerCoords = GetEntityCoords(PlayerPedId())
            Dumpster2 = GetClosestObjectOfType(PlayerCoords, 3.0, 666561306, false, false, false)
            if Dumpster2 ~= 0 then
...
CreateThread(function()
	while true do
        ...
        if not (NearbyDumpster1 or NearbyDumpster2 or NearbyDumpster4 or NearbyDumpster5 or NearbyDumpster6) then 
            WaitTime = 500
            local PlayerCoords = GetEntityCoords(PlayerPedId())
            Dumpster3 = GetClosestObjectOfType(PlayerCoords, 3.0, -58485588, false, false, false)
            if Dumpster3 ~= 0 then
...
CreateThread(function()
	while true do
        ...
        if not (NearbyDumpster1 or NearbyDumpster2 or NearbyDumpster3 or NearbyDumpster5 or NearbyDumpster6) then 
            WaitTime = 500
            local PlayerCoords = GetEntityCoords(PlayerPedId())
            Dumpster4 = GetClosestObjectOfType(PlayerCoords, 3.0, -206690185, false, false, false)
            if Dumpster4 ~= 0 then
...
CreateThread(function()
	while true do
        ...
        if not (NearbyDumpster1 or NearbyDumpster2 or NearbyDumpster3 or NearbyDumpster4 or NearbyDumpster6) then 
            WaitTime = 500
            local PlayerCoords = GetEntityCoords(PlayerPedId())
            Dumpster5 = GetClosestObjectOfType(PlayerCoords, 3.0, 1511880420, false, false, false)
            if Dumpster5 ~= 0 then
...
CreateThread(function()
	while true do
        ...
        if not (NearbyDumpster1 or NearbyDumpster2 or NearbyDumpster3 or NearbyDumpster4 or NearbyDumpster5) then 
            WaitTime = 500
            local PlayerCoords = GetEntityCoords(PlayerPedId())
            Dumpster6 = GetClosestObjectOfType(PlayerCoords, 3.0, 682791951, false, false, false)
            if Dumpster6 ~= 0 then
...
-- Show Text On Dumpster When Nearby And Check For Button Presses
-- Different Thread for optimization purposes (From 0.35ms to 0.05ms)
CreateThread(function()
	while true do
        local WaitTime = 400
        if NearbyDumpster1 then
            ...
            if IsControlJustReleased(0, 38) then
                TriggerServerEvent('qb-dumpsters:timer:check', Dumpster1)
            end
        end
        if NearbyDumpster2 then
            ...
            if IsControlJustReleased(0, 38) then
                TriggerServerEvent('qb-dumpsters:timer:check', Dumpster2)
            end
        end
        if NearbyDumpster3 then
            ...
            if IsControlJustReleased(0, 38) then
                TriggerServerEvent('qb-dumpsters:timer:check', Dumpster3)
            end
        end
        if NearbyDumpster4 then
            ...
            if IsControlJustReleased(0, 38) then
                TriggerServerEvent('qb-dumpsters:timer:check', Dumpster4)
            end
        end
        if NearbyDumpster5 then
            ...
            if IsControlJustReleased(0, 38) then
                TriggerServerEvent('qb-dumpsters:timer:check', Dumpster5)
            end
        end
        if NearbyDumpster6 then
            ...
            if IsControlJustReleased(0, 38) then
                TriggerServerEvent('qb-dumpsters:timer:check', Dumpster6)
            end
        end
        Wait(WaitTime)
    end

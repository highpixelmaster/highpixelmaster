...
local function OnPlayerConnecting(name, setKickReason, deferrals)
    ...
    deferrals.update(string.format("Hello %s. We are checking your ID.", name))
    ...
    deferrals.update(string.format("Hello %s. We are checking to see if youre deported.", name))

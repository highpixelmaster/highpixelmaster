...
Citizen.CreateThread(function()
	...
	while true do
		SetDiscordAppId(888201051612774411)
		SetDiscordRichPresenceAsset("logoicon")
		SetDiscordRichPresenceAction(0, "Join Our Discord", "https://discord.io/highpixelfivem")
		SetDiscordRichPresenceAction(1, "Join Our Server", "")

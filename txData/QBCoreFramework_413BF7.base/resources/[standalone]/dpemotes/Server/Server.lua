...
if Config.SqlKeybinding then
	...
	AddEventHandler("dp:ServerKeybindGrab", function()
		...
		exports.oxmysql:fetch("SELECT keybind1, emote1, keybind2, emote2, keybind3, emote3, keybind4, emote4, keybind5, emote5, keybind6, emote6 FROM `dpkeybinds` WHERE id = ?", {license}, function(kb)
	...
	AddEventHandler("dp:ServerKeybindUpdate", function(key, emote)
		...
		if chosenk == "keybind1" then
			exports.oxmysql:fetch("UPDATE dpkeybinds SET emote1=@emote WHERE id = ?", {license, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind2" then
			exports.oxmysql:fetch("UPDATE dpkeybinds SET emote2=@emote WHERE id = ?", {license, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind3" then
			exports.oxmysql:fetch("UPDATE dpkeybinds SET emote3=@emote WHERE id = ?", {license, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind4" then
			exports.oxmysql:fetch("UPDATE dpkeybinds SET emote4=@emote WHERE id = ?", {license, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind5" then
			exports.oxmysql:fetch("UPDATE dpkeybinds SET emote5=@emote WHERE id = ?", {license, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		elseif chosenk == "keybind6" then
			exports.oxmysql:fetch("UPDATE dpkeybinds SET emote6=@emote WHERE id = ?", {license, emote = emote }, function()
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote)
			end)
		end
	end)
